...
Public Class frmKiosk
    ...
    Private Sub btnGetTicket_MouseEnter(sender As Object, e As EventArgs) Handles btnGetTicket.MouseEnter
        btnGetTicket.BackColor = Color.FromArgb(0, 86, 179)
    End Sub
    ...
    Private Sub btnNewTransaction_MouseEnter(sender As Object, e As EventArgs) Handles btnNewTransaction.MouseEnter
        btnNewTransaction.BackColor = Color.DarkGray
    End Sub
    ...
    Private Sub AdjustLabelFont(lbl As Label)
        ...
        Dim maxSize As Size = New Size(lbl.Width, Integer.MaxValue)
        Dim initialFontSize As Single = 60.0F
        ...
        Do
            ...
            If measuredSize.Width > lbl.Width Then
            ...
            End If
            currentFont.Dispose()
        Loop While currentFontSize > 12
        If lbl.Font.Size < 12 Then
            lbl.Font = New Font(lbl.Font.FontFamily, 12.0F, lbl.Font.Style)
        End If
    End Sub
    ...
    Private Sub FetchStudentDetails(studentNumber As String)
        ...
        End If
        Dim query As String = "SELECT student_id, last_name, first_name, course FROM students WHERE student_number = @student_number"
        Using conn As New MySqlConnection(DatabaseHelper.GetConnectionString())
            Try
                conn.Open()
                Using cmd As New MySqlCommand(query, conn)
