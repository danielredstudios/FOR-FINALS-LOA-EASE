    ...
    <div class="styled-card" style="max-width: 500px;"> <!-- Use styled-card -->
        <div class="card-content">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">Enter your institutional email to receive a password reset link.</p>
            </div>
            ...
            <form id="forgotPasswordForm">
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" placeholder="e.g., CXXXX-XX@itmlyceum.com" required>
                    </div>
                </div>
                <div class="d-grid">
